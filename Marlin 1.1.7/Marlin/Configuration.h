...
#define STRING_CONFIG_H_AUTHOR "(Varul Dogra, Trendonix)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 97.59 }
